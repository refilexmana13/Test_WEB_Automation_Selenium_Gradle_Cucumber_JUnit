...
Project automation ini dibuat menggunakan **Java**, **Selenium**, dan **Cucumber (BDD)** untuk melakukan testing pada website [SauceDemo](https://www.saucedemo.com/).

## Praktikum ini dilakukan mengguunakan = 
 **Java SDK 25.0.1**  
